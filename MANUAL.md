...
- **BECAUSE** - the source that fired (pinned, a learned email rule,
  ...
  spot: everything irrelevant dims, the candidates show dashed outlines
  (all selected), click any to keep or drop it, and one approve moves
  the survivors - your word, one ⌘Z. If something LEARNED
