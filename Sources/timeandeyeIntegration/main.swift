...
//
// Usage: swift run timeandeyeIntegration <base-url> <api-key-file>
...
guard CommandLine.arguments.count >= 3,
    ...
    fail("usage: timeandeyeIntegration <base-url> <api-key-file> [keep]")
}
...
func run() async throws {
    ...
    let scratchSubject = "timeandeye integration scratch (auto-created, safe to delete)"
    var scratchID: Int?
    let filters = #"[{"subject":{"operator":"~","values":["timeandeye integration scratch"]}}]"#
