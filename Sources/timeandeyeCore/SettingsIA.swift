    ...
    package static let items: [Item] = [
        ...
        Item("colours.rederive", "Re-derive automatic colours",
             ["re-apply", "from scratch", "cohesive", "palette", "reset colours",
              "color"], .colours),
        Item("colours.save", "Save palette",
             ["export", "backup", "colour set", "color"], .colours),
        Item("colours.saveGeneric", "Save generic palette",
             ["export", "colours only", "share", "seed", "color"], .colours),
        ...
        Item("email.health", "Email matching health",
             ["stopped", "unhealthy", "broken", "capture", "correspondent",
              "not working"], .emailCalendar),
